...
COMMANDS=(
    ...
    ""
    "<span color='gray'><i>AI/Claude Commands:</i></span>"
    "<b>🤖 zed-status</b>  <i>Show ZED-AI GLM-4.6 configuration status</i>"
    "<b>🤖 zed-ai-status</b>  <i>Show ZED-AI GLM-4.6 configuration status (full command)</i>"
    "<b>🤖 zed-ai-set</b>  <i>Manually set ZED-AI environment variables in current session</i>"
    "<b>🤖 zed-ai-unset</b>  <i>Unset ZED-AI environment variables in current session</i>"
    "<b>⚡ cc</b>  <i>Claude Code quick prompt</i>"
    "<b>📝 ccommit</b>  <i>Claude Code commit with push</i>"
    ""
